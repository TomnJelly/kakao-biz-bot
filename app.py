...
def run_analysis(client, user_text, image_url):
    ...
    # 🚀 호출할 때마다 모델을 번갈아 선택 (0, 1, 0, 1...)
    selected_model = MODELS[call_count % 2]
    call_count += 1
    ...
    try:
        ...
        print(f"Analysis Error ({selected_model}): {e}")
